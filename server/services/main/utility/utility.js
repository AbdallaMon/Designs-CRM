  ...
  switch (error.code) {
    case "P2002":
      if (
        ...
        response = { status: 409, message: "This email is already registered" };
      } else {
        response = {
          status: 409,
    ...
    case "P2004":
      response = {
        status: 400,
        message: `Invalid constraint: ${error.meta.constraint}`,
      };
      break;
    ...
    case "P2025":
      response = {
        status: 404,
        message: `Resource not found: ${error.meta.cause}`,
      };
      break;
    ...
    case "P2016":
      response = {
        status: 400,
        message: `Invalid data provided: ${error.meta.details}`,
      };
      break;
    ...
    case "P2000":
      response = {
        status: 400,
        message: `Invalid column length: ${error.meta.column}`,
      };
      break;
    ...
    case "P2017":
      response = {
        status: 400,
        message: `Invalid relation: ${error.meta.relation_name}`,
      };
      break;
    ...
    case "P2014":
      response = {
        status: 400,
        message: `Invalid relation delete attempt: ${error.meta.relation_name}`,
      };
      break;
    ...
    case "P2026":
      response = {
        status: 500,
        message: `Internal server error: ${error.meta.details}`,
      };
      break;

...
export const newLeadLink = origin + "/dashboard/leads/";

export const userLink = origin + "/dashboard/users/";
export const workStagesLink = origin + "/dashboard/work-stages/";
export const threeDworkStageLink = origin + "/dashboard/work-stages/three-d/";

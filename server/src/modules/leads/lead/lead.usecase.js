...
const legacyDefaults = {
  ...
  assignLeadToAUser: (...a) => import("../../../shared/legacy/index.js").then((m) => m.assignLeadToAUser(...a)),
  bulkAssignLeadTsoAUser: (...a) => import("../../../shared/legacy/index.js").then((m) => m.bulkAssignLeadTsoAUser(...a)),
  markClientLeadAsConverted: (...a) => import("../../../shared/legacy/index.js").then((m) => m.markClientLeadAsConverted(...a)),
  updateClientLeadStatus: (a) => import("../../../shared/legacy/index.js").then((m) => m.updateClientLeadStatus(a)),
  checkIfUserAllowedToTakeALead: (...a) => import("../../../shared/legacy/index.js").then((m) => m.checkIfUserAllowedToTakeALead(...a)),
  remindUserToPay: (a) => import("../../../shared/legacy/index.js").then((m) => m.remindUserToPay(a)),
  remindUserToCompleteRegister: (a) => import("../../../shared/legacy/index.js").then((m) => m.remindUserToCompleteRegister(a)),
  ...
  makePayments: (...a) => import("../../../shared/legacy/index.js").then((m) => m.makePayments(...a)),
  makeExtraServicePayments: (a) => import("../../../shared/legacy/index.js").then((m) => m.makeExtraServicePayments(a)),
  editPriceOfferStatus: (...a) => import("../../../shared/legacy/index.js").then((m) => m.editPriceOfferStatus(...a)),
  getClientLeadsByDateRange: (a) => import("../../../shared/legacy/index.js").then((m) => m.getClientLeadsByDateRange(a)),
  getClientLeadsColumnStatus: (a) => import("../../../shared/legacy/index.js").then((m) => m.getClientLeadsColumnStatus(a)),
};

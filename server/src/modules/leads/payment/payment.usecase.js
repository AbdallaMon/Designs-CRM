...
export async function remindUserToPay({ clientLeadId }) {
  ...
  if (!reuseExistingSession) {
    session = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.DASHBOARD_ORIGIN}/success?session_id={CHECKOUT_SESSION_ID}&clientId=${clientLead.client.id}&clientLeadId=${clientLead.id}&lng=ar`,
      cancel_url: `${process.env.DASHBOARD_ORIGIN}/cancel?session_id={CHECKOUT_SESSION_ID}&clientId=${clientLead.client.id}&clientLeadId=${clientLead.id}&lng=ar`,

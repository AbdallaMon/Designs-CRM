...
// domain root sends you into the new app — authenticated users land on the v2 dashboard;
// unauthenticated users fall through the v2 AuthProvider's session check to /login.

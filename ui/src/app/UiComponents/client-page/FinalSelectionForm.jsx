...
import {Autocomplete, Box, Button, Paper, Stack, TextField, Typography, useMediaQuery, useTheme} from "@mui/material";
...
export function FinalSelectionForm({category, item}) {

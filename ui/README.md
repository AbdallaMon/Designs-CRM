...
- When adding note ask user if he want to add it to updates like tasks and user update is it done or not and if user read it we can make it done to hide it and allow admin to hide it anyway
- Can delete an update

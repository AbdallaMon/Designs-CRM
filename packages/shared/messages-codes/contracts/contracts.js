...
export const contractsMessagesCodes = {
  ...
  CONTRACT_PAYMENTS_REQUIRED: "CONTRACT_PAYMENTS_REQUIRED",
  CONTRACT_PAYMENT_AMOUNT_INVALID: "CONTRACT_PAYMENT_AMOUNT_INVALID",
  CONTRACT_PAYMENT_CONDITION_INVALID: "CONTRACT_PAYMENT_CONDITION_INVALID",
  CONTRACT_STAGES_REQUIRED: "CONTRACT_STAGES_REQUIRED",
  CONTRACT_STAGE_DAYS_INVALID: "CONTRACT_STAGE_DAYS_INVALID",
  CONTRACT_STAGE_COMPLETED: "CONTRACT_STAGE_COMPLETED",
  CONTRACT_STAGE_OVERRIDE_CANCELLED: "CONTRACT_STAGE_OVERRIDE_CANCELLED",
  CONTRACT_PAYMENT_NOT_DUE: "CONTRACT_PAYMENT_NOT_DUE",
  CONTRACT_SIGNATURE_PAYMENT_REQUIRED: "CONTRACT_SIGNATURE_PAYMENT_REQUIRED",
  CONTRACT_PAYMENT_NOT_FOUND: "CONTRACT_PAYMENT_NOT_FOUND",
  CONTRACT_PAYMENT_AMOUNTS_INVALID: "CONTRACT_PAYMENT_AMOUNTS_INVALID",
  CONTRACT_PAYMENT_AMOUNTS_EXCEED_TOTAL: "CONTRACT_PAYMENT_AMOUNTS_EXCEED_TOTAL",
};

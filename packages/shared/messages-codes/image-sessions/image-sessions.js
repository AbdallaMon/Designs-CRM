...
export const imageSessionsMessagesCodes = {
  ...
  // ── ADMIN reference-data validation (missing/empty required fields on create/edit) ──
  // These REPLACE the legacy plain-prose `throw new Error(...)` in the admin repos, which
  // the error handler could only surface as a generic 500. Thrown as AppError(code, 400).
  IMAGE_SESSION_TEMPLATE_REQUIRED: "IMAGE_SESSION_TEMPLATE_REQUIRED",
  IMAGE_SESSION_TITLE_REQUIRED: "IMAGE_SESSION_TITLE_REQUIRED",
  IMAGE_SESSION_TITLES_REQUIRED: "IMAGE_SESSION_TITLES_REQUIRED",
  IMAGE_SESSION_DESCRIPTIONS_REQUIRED: "IMAGE_SESSION_DESCRIPTIONS_REQUIRED",
  IMAGE_SESSION_BACKGROUND_REQUIRED: "IMAGE_SESSION_BACKGROUND_REQUIRED",
  IMAGE_SESSION_COLORS_REQUIRED: "IMAGE_SESSION_COLORS_REQUIRED",
  IMAGE_SESSION_STYLE_REQUIRED: "IMAGE_SESSION_STYLE_REQUIRED",
  IMAGE_SESSION_SPACE_REQUIRED: "IMAGE_SESSION_SPACE_REQUIRED",
  IMAGE_SESSION_IMAGE_REQUIRED: "IMAGE_SESSION_IMAGE_REQUIRED",
  IMAGE_SESSION_TYPE_REQUIRED: "IMAGE_SESSION_TYPE_REQUIRED",
  IMAGE_SESSION_FIELDS_REQUIRED: "IMAGE_SESSION_FIELDS_REQUIRED", // generic "fill all data"
  ...
  IMAGE_SESSION_SPACES_REQUIRED: "IMAGE_SESSION_SPACES_REQUIRED",
  IMAGE_SESSION_SUBMITTED_LOCKED: "IMAGE_SESSION_SUBMITTED_LOCKED",
};

// Tests moved to tests/normalize-upload-references.test.js so the root Vitest include picks them up.
/*
import { describe, expect, it } from "vitest";
import { normalizeStoredValue } from "../normalize-upload-references.mjs";

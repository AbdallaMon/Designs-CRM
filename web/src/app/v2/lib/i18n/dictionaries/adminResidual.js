...
export const ar = {
  ...
  "adminResidual.leads.create.field.email.required": "البريد الإلكتروني مطلوب",
  "adminResidual.leads.create.field.category": "التصنيف",
  "adminResidual.leads.create.field.category.required": "التصنيف مطلوب",
  "adminResidual.leads.create.field.item": "النوع",
  "adminResidual.leads.create.field.item.required": "النوع مطلوب",
  "adminResidual.leads.create.field.item.hint": "اختر التصنيف أولاً",
  "adminResidual.leads.create.field.location": "الموقع",
...
export const en = {
  ...
  "adminResidual.leads.create.field.email.required": "Email is required",
  "adminResidual.leads.create.field.category": "Category",
  "adminResidual.leads.create.field.category.required": "Category is required",
  "adminResidual.leads.create.field.item": "Type",
  "adminResidual.leads.create.field.item.required": "Type is required",
  "adminResidual.leads.create.field.item.hint": "Choose a category first",
  "adminResidual.leads.create.field.location": "Location",

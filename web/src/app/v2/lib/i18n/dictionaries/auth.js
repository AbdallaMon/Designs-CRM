// Per-feature UI dictionary stub: auth screens (login, etc.)
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "auth.*" (e.g. "auth.title", "auth.actions.create"). The barrel
...
// just fill this file and call t("auth.<key>") in the feature's components.
//

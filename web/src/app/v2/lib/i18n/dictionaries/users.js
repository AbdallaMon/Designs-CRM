// Per-feature UI dictionary stub: users list
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "users.*" (e.g. "users.title", "users.actions.create"). The barrel
...
// just fill this file and call t("users.<key>") in the feature's components.
//

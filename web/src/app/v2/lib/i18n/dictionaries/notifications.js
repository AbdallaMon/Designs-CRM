// Per-feature UI dictionary stub: notifications
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "notifications.*" (e.g. "notifications.title", "notifications.actions.create"). The barrel
...
// just fill this file and call t("notifications.<key>") in the feature's components.
//

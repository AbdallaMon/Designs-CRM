// Per-feature UI dictionary stub: project detail screen + tabs
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "projectsDetails.*" (e.g. "projectsDetails.title", "projectsDetails.actions.create"). The barrel
...
// just fill this file and call t("projectsDetails.<key>") in the feature's components.
//

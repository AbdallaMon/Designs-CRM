// Per-feature UI dictionary stub: user detail / profile screen
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "usersDetails.*" (e.g. "usersDetails.title", "usersDetails.actions.create"). The barrel
...
// just fill this file and call t("usersDetails.<key>") in the feature's components.
//

// Per-feature UI dictionary stub: accounting / finance
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "accounting.*" (e.g. "accounting.title", "accounting.actions.create"). The barrel
...
// just fill this file and call t("accounting.<key>") in the feature's components.
//

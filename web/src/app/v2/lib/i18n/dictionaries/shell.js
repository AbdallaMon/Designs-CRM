// Per-feature UI dictionary stub: the dashboard shell + nav chrome
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "shell.*" (e.g. "shell.title", "shell.actions.create"). The barrel
...
// just fill this file and call t("shell.<key>") in the feature's components.
//

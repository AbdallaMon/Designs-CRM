// Per-feature UI dictionary stub: leads list / sales pipeline
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "leads.*" (e.g. "leads.title", "leads.actions.create"). The barrel
...
// just fill this file and call t("leads.<key>") in the feature's components.
//

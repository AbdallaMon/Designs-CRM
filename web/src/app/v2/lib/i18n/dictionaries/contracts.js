// Per-feature UI dictionary stub: contracts
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "contracts.*" (e.g. "contracts.title", "contracts.actions.create"). The barrel
...
// just fill this file and call t("contracts.<key>") in the feature's components.
//

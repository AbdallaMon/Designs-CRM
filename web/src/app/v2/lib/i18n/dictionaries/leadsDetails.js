// Per-feature UI dictionary stub: lead detail screen + tabs
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "leadsDetails.*" (e.g. "leadsDetails.title", "leadsDetails.actions.create"). The barrel
...
// just fill this file and call t("leadsDetails.<key>") in the feature's components.
//

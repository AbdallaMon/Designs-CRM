// Per-feature UI dictionary stub: analytics dashboard
//
// COMPOSITION MODEL: one file per feature/area. Fill BOTH `ar` and `en` with the SAME keys,
// namespaced under "dashboard.*" (e.g. "dashboard.title", "dashboard.actions.create"). The barrel
...
// just fill this file and call t("dashboard.<key>") in the feature's components.
//

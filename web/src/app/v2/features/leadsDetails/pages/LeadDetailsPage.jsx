...
//
// DEFERRED (reported): the cross-feature tabs the legacy dialog also showed — Sales stage,
// Client analysis (sales tools), Projects, Tasks/Modifications, Lead updates, Chats — they
// belong to OTHER not-yet-migrated FE modules (/v2/sales-stages, /v2/projects, /v2/tasks,
// /v2/chat) and are out of scope for the leads migration pass.
...
export function LeadDetailsPage({ leadId }) {
  ...
  const sections = useMemo(() => {
    ...
    return s;
  }, [caps.canAddPriceOffer, caps.canAddPayment, caps.canSendReminder]);

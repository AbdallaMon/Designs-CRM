...
export function DashboardPage() {
  ...
  // Read-only fixed-data reference card — surfaced to every employee who holds the same list code
  // the BE enforces (utility.fixed_data.list). The manager's admin fixed-data editor is unchanged.

...
/**
 * Self-contained v2 utilities route shell. Composes the v2 provider stack (RTL emotion cache +
 * v2 theme + v2 Toast + v2 Auth) so the utilities feature runs on the canonical v2 layer WITHOUT
 ...
 */
export default function V2UtilitiesLayout({ children }) {
  return (

...
function FixedCardData({ data, admin, setData }) {
  ...
  return (
    ...
    >
      ...
      <CardContent
        sx={{ height: "100px", overflowY: "auto", padding: "4px !important" }}
      >
        ...
        >
          <IconButton size="small" onClick={() => handleCopy(data.title)}>
            <FiCopy />
          </IconButton>
          {data.title}
        </Typography>
        ...
        >
          <IconButton size="small" onClick={() => handleCopy(data.description)}>
            <FiCopy />
          </IconButton>

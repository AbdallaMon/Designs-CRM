    ...
    <Card sx={{ height: "100%", boxShadow: 3, position: "relative" }}>
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="textSecondary" gutterBottom>
          This analysis includes leads and performance data from the last month
          until today, comparing the performance of different emirates.
        </Typography>
              ...
              <Grid size={{ xs: 12, md: 4 }} key={emirate.emirate}>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Typography variant="body2" color="textSecondary">
                      Avg. Value: AED{" "}
                      {emirate.averageLeadPrice.toLocaleString()}
                    </Typography>
                    <Typography variant="body2" color="textSecondary">
